...
export const LayoutVariant1 = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Variant 1: Traditional Top Header */}
      <div className="border-b border-border bg-card shadow-sm">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <img src="/lovable-uploads/85999b6d-54f3-48eb-aa3f-eb0802e5d23b.png" alt="NC Talavera Seafoods" className="h-12 w-auto" />
              <div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              <div className="relative flex-1">
                ...
                <Input placeholder="Search products, categories, or SKU..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10" />
              </div>
